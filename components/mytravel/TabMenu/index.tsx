export default function TabMenu() {
  return (
    <div className="absolute z-20 flex h-72 w-[480px] items-center justify-center rounded-36 bg-white px-48 py-10 shadow-md tablet:h-64 tablet:w-[420px] mobile:h-56 mobile:w-312 mobile:px-24">
