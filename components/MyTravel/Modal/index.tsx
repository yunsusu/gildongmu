        ...
        >
          ...
          <div className="flex w-full flex-col justify-center px-40 pb-40 pt-30 tablet:px-32 tablet:pt-32 mobile:p-24">
            <div className="mb-20 flex w-full items-center justify-between mobile:flex-col-reverse mobile:items-start mobile:gap-12">
              ...
              <div
                className={`rounded-24 border px-16 py-7 text-16 leading-[130%] tracking-[-0.6px] ${data.status === "모집 중" ? "border-none bg-pink-100 text-pink-500" : " border-stone-400 bg-white text-stone-400"} tablet:px-12 tablet:py-5 tablet:text-14`}
              >
                {data.status}
              </div>
            </div>
